...
This project has been completed after getting the concepts of scenario which is described in the above question file. The main project file is listed inside doc directory, and the overall project sql dmp file is listed in the main home directory. Listed below screenshot is some of the many data from the above project.
